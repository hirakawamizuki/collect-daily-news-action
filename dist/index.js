...
const convert = __webpack_require__(8821);
const options = {ignoreComment: true, alwaysChildren: true, compact: true};  // format setting to convert from xml to json
const dateFormat = __webpack_require__(1512);
const date = new Date();
const shapeOutput = __webpack_require__(4439);
